...
#define TILERENDERING_EXT_START TileRenderer::getInstance().startTileRendering
#define TILERENDERING_EXT_END TileRenderer::getInstance().endTileRendering
#define TILERENDERING_START TileRenderer::getInstance().startTiling
#define TILERENDERING_END TileRenderer::getInstance().endTiling
#define TILERENDERING_CLEARCACHE TileRenderer::getInstance().clearCache
